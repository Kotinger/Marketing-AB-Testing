...
588 101 пользователь. Рандом: **control = psa** , **treatment = ad**.  
...
- Из тех, кто видел PSA, купили **1.79%**. Из тех, кто видел рекламу - **2.55%**. Разница **+0.77 пункта** в пользу ads.
- Это не случайность: тест показывает уверенный плюс.
- Группы по размеру (4.00% psa / 96.00% ad).
...
Одна таблица `clean_users`. Связей нет.
